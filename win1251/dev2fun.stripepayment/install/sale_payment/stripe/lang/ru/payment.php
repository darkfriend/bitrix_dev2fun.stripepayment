...
$MESS["STRIPE_TEST_SOURCE_WEBHOOK"]="Укажите тестовый Webhook-token";
...
$MESS["STRIPE_TEST_SOURCE_WEBHOOK_DESCR"]="Вам нужно указать тестовый Webhook-token, чтоб работали вебхуки.";
